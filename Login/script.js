...
formLogin.addEventListener("submit", async (e) => {
  ...
  if (response.length > 0) {
    // Login bem-sucedido
    tempovalioso.setItem('login', response[0].email);  // Armazena o email do usuário logado
    // Aleta personalizado
    ativarModal("Sucesso", "Login realizado com sucesso!", "normal");
    console.log(tempovalioso.getItem('login'))
    console.log(tempovalioso.getItem('TotalPontos'))
